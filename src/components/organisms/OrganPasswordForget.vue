    ...
    <section class="px-5">
        <div class="container mx-auto">
            <div class="flex items-center justify-center mt-6">
                <p class="w-2/3 pb-4 font-medium text-white text-3xl capitalize border-b border-sky-400">
                    請輸入信箱
                </p>
            </div>
            <p class="mt-10 text-lg text-left">請輸入您註冊時的信箱，我們會發送更新密碼的連結到您的信箱</p>
            <div class="text-lg max-md:text-sm text-left text-gray-300 mt-2">
