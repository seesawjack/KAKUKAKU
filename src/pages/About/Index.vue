<template>
  ...
  <script setup>
  import AtmosAccordion from "@/components/atmos/AtmosAccordion.vue";
  ...
  const faq = [
    ...
    },
    {
      ...
      body: "因最初設計時，電腦版以編輯功能為主，手機版以適合觀看歌詞為主，故有些編輯功能在手機上是看不到的。",
    },
    {
      header: "會員資料的內容為什麼需要填寫「生日」及「日本語能力」?",
      body: "會員資料只有網站管理員看得到且會嚴密保護，以上資料可協助管理員分析用以改善網站功能。",
    },
  ]
